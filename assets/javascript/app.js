        ...
        $("tr").on("click", function(){
          ...
          function displayVideos(){
              ...
              $.ajax({
                  ...
                  for (var i = 0; i < 3; i++){
                      var video = $("<iframe>");
                      video.addClass("video w100").attr("width","500").attr("height","300").css("padding","10px").css("border","1px").attr("src","https://www.youtube.com/embed/"+response.items[i].id.videoId).attr("frameborder","0").attr("allowfullscreen");
